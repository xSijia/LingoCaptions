...
def translation_continuous_from_file():
...
def translation_continuous_from_mic():
    """performs continuous speech translation from input from an audio file"""
    # <TranslationContinuous>
    # set up translation parameters: source language and target languages
    translation_config = speechsdk.translation.SpeechTranslationConfig(
        subscription=speech_key, region=service_region,
        speech_recognition_language='en-US',
        target_languages=('es', 'zh-Hans', 'vi'), voice_name="de-DE-Hedda")
...
translation_continuous_from_mic()
